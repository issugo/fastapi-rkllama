...
class PullSupplier:
    ...
    def file_info(
        ...
        logger.debug(
            f"PullSupplier.file_info(model_name={model_name}, file={file}, repo={repo}, model_type={model_type}, supplier={supplier})"
        )
        raise Exception("abstract method")
    ...
    def check_file_info(
        ...
        logger.debug(
            f"PullSupplier.check_file_info(model_name={model_name}, file={file}, repo={repo}, model_type={model_type}, file_info={file_info})"
        )
        raise Exception("abstract method")
    ...
    def model_file_info(
        ...
        logger.debug(
            f"PullSupplier.model_file_info(model_name={model_name}, file={file}, repo={repo}, model_type={model_type}, file_info={file_info}, supplier={supplier})"
        )
        raise Exception("abstract method")
    ...
    def check_model_file_info(
        ...
        logger.debug(
            f"PullSupplier.check_model_file_info(model_name={model_name}, file={file}, repo={repo}, model_type={model_type}, file_info={file_info}, model_file_info={model_file_info})"
        )
        raise Exception("abstract method")
