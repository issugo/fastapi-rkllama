...
class Server(BaseModel):
    ...
    max_number_models_loaded_in_memory: Annotated[int, Field( default=1, description="Maximum number of models loaded into memory")]
    max_minutes_loaded_in_memory: Annotated[int, Field( default=180, description="Maximum number of minutes loaded into memory")]
